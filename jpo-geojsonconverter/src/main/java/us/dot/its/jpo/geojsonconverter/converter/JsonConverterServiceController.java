...
public class JsonConverterServiceController {
    ...
    public JsonConverterServiceController(GeoJsonConverterProperties geojsonProps, MapJsonValidator mapJsonValidator,
        ...
        try {
            ...
            mapStreams.setUncaughtExceptionHandler(new StreamsExceptionHandler("MapStreams"));
            ...
            spatStreams.setUncaughtExceptionHandler(new StreamsExceptionHandler("SpatStreams"));
