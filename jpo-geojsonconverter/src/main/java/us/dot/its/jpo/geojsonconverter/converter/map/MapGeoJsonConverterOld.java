...
public class MapGeoJsonConverterOld extends AbstractSubscriberProcessor<String, String> {
  private Logger logger = LoggerFactory.getLogger(this.getClass());

	private GeoJsonConverterProperties geojsonProperties;
	private MessageProducer<String, String> geoJsonProducer;

	public MapGeoJsonConverterOld(GeoJsonConverterProperties geojsonProps) {
		super();
